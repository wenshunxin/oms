...
export var  api= {
    ...
    //修改头像
    UserPhoto : URL + "/oms/userController/updateUserPhoto.act",
    //修改个人信息
    ...
    // 施工完成
    sendMessage : URL + "/oms/customerOrderController/implementEnd.act?token=" + TOKEN,
    //所有实施人员
    ...
    //查看设备指令详情
    getEquipmentInstruction : URL + "/oms/instructionController/getEquipmentInstruction.act",
    //读取消息
    updateReadStatus : URL + "/oms/messageController/updateReadStatus.act"
}
